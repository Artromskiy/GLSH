...
namespace GLSH
{
    ...
    public struct float3
    {
        ...
        /// </summary>
        public static float3 Clamp(float3 v, float min, float max) => new float3(float.Clamp(v.x, min, max), float.Clamp(v.y, min, max), float.Clamp(v.z, min, max));
