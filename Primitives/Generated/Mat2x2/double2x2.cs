...
namespace GLSH
{
    ...
    public struct double2x2
    {
        ...
        /// </summary>
        public static double2x2 Inverse(double2x2 v) => double2x2.Adjugate(v) / double2x2.Determinant(v);
        ...
        /// </summary>
        private static double2x2 Divide(double2x2 A, double2x2 B) => A * double2x2.Inverse(B);

        /// <summary>
        /// 
        /// </summary>
        private static double2x2 Adjugate(double2x2 v) => new double2x2(v.m11, v.m01, v.m11, v.m01);
