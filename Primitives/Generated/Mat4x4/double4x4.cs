...
namespace GLSH
{
    ...
    public struct double4x4
    {
        ...
        /// 
        /// </summary>
        public static double Determinant(double4x4 v) => v[0, 0] * (v[1, 1] * (v[2, 2] * v[3, 3] - v[3, 2] * v[2, 3]) - v[2, 1] * (v[1, 2] * v[3, 3] - v[3, 2] * v[1, 3]) + v[3, 1] * (v[1, 2] * v[2, 3] - v[2, 2] * v[1, 3])) - v[1, 0] * (v[0, 1] * (v[2, 2] * v[3, 3] - v[3, 2] * v[2, 3]) - v[2, 1] * (v[0, 2] * v[3, 3] - v[3, 2] * v[0, 3]) + v[3, 1] * (v[0, 2] * v[2, 3] - v[2, 2] * v[0, 3])) + v[2, 0] * (v[0, 1] * (v[1, 2] * v[3, 3] - v[3, 2] * v[1, 3]) - v[1, 1] * (v[0, 2] * v[3, 3] - v[3, 2] * v[0, 3]) + v[3, 1] * (v[0, 2] * v[1, 3] - v[1, 2] * v[0, 3])) - v[3, 0] * (v[0, 1] * (v[1, 2] * v[2, 3] - v[2, 2] * v[1, 3]) - v[1, 1] * (v[0, 2] * v[2, 3] - v[2, 2] * v[0, 3]) + v[2, 1] * (v[0, 2] * v[1, 3] - v[1, 2] * v[0, 3]));
