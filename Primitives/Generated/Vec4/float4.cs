...
namespace GLSH
{
    ...
    public struct float4
    {
        ...
        /// </summary>
        public static float4 Clamp(float4 v, float min, float max) => new float4(float.Clamp(v.x, min, max), float.Clamp(v.y, min, max), float.Clamp(v.z, min, max), float.Clamp(v.w, min, max));
