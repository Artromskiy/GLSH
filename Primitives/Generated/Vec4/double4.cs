...
namespace GLSH
{
    ...
    public struct double4
    {
        ...
        /// </summary>
        public static double4 Clamp(double4 v, double min, double max) => new double4(double.Clamp(v.x, min, max), double.Clamp(v.y, min, max), double.Clamp(v.z, min, max), double.Clamp(v.w, min, max));
