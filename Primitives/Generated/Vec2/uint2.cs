...
namespace GLSH
{
    ...
    public struct uint2
    {
        ...
        /// </summary>
        public static uint2 Clamp(uint2 v, uint min, uint max) => new uint2(uint.Clamp(v.x, min, max), uint.Clamp(v.y, min, max));
        ...
        /// <summary>
        /// Returns a uint2 from component-wise application of operator&lt;&lt; (lhs &lt;&lt; (int)rhs).
        /// </summary>
        public static uint2 operator<<(uint2 lhs, uint2 rhs) => new uint2(lhs.x << (int)rhs.x, lhs.y << (int)rhs.y);
        
        /// <summary>
        /// Returns a uint2 from component-wise application of operator&lt;&lt; (lhs &lt;&lt; (int)rhs).
        /// </summary>
        public static uint2 operator<<(uint2 lhs, uint rhs) => new uint2(lhs.x << (int)rhs, lhs.y << (int)rhs);
