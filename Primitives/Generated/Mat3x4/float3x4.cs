...
namespace GLSH
{
    ...
    public struct float3x4
    {
        ...
        /// </summary>
        public float3x4(float4 v0, float4 v1, float4 v2)
        {
            this[0] = v0;
            this[1] = v1;
            this[2] = v2;
        ...
        /// </summary>
        public static float2x4 operator *(float3x4 lhs, float2x3 rhs) => new float2x4(lhs[0, 0] * rhs[0, 0] + lhs[1, 0] * rhs[0, 1] + lhs[2, 0] * rhs[0, 2], lhs[0, 1] * rhs[0, 0] + lhs[1, 1] * rhs[0, 1] + lhs[2, 1] * rhs[0, 2], lhs[0, 2] * rhs[0, 0] + lhs[1, 2] * rhs[0, 1] + lhs[2, 2] * rhs[0, 2], lhs[0, 3] * rhs[0, 0] + lhs[1, 3] * rhs[0, 1] + lhs[2, 3] * rhs[0, 2], lhs[0, 0] * rhs[1, 0] + lhs[1, 0] * rhs[1, 1] + lhs[2, 0] * rhs[1, 2], lhs[0, 1] * rhs[1, 0] + lhs[1, 1] * rhs[1, 1] + lhs[2, 1] * rhs[1, 2], lhs[0, 2] * rhs[1, 0] + lhs[1, 2] * rhs[1, 1] + lhs[2, 2] * rhs[1, 2], lhs[0, 3] * rhs[1, 0] + lhs[1, 3] * rhs[1, 1] + lhs[2, 3] * rhs[1, 2]);

        /// <summary>
        /// Executes a matrix-matrix-multiplication float3x4 * float3x3 -> float3x4.
        /// </summary>
        public static float3x4 operator *(float3x4 lhs, float3x3 rhs) => new float3x4(lhs[0, 0] * rhs[0, 0] + lhs[1, 0] * rhs[0, 1] + lhs[2, 0] * rhs[0, 2], lhs[0, 1] * rhs[0, 0] + lhs[1, 1] * rhs[0, 1] + lhs[2, 1] * rhs[0, 2], lhs[0, 2] * rhs[0, 0] + lhs[1, 2] * rhs[0, 1] + lhs[2, 2] * rhs[0, 2], lhs[0, 3] * rhs[0, 0] + lhs[1, 3] * rhs[0, 1] + lhs[2, 3] * rhs[0, 2], lhs[0, 0] * rhs[1, 0] + lhs[1, 0] * rhs[1, 1] + lhs[2, 0] * rhs[1, 2], lhs[0, 1] * rhs[1, 0] + lhs[1, 1] * rhs[1, 1] + lhs[2, 1] * rhs[1, 2], lhs[0, 2] * rhs[1, 0] + lhs[1, 2] * rhs[1, 1] + lhs[2, 2] * rhs[1, 2], lhs[0, 3] * rhs[1, 0] + lhs[1, 3] * rhs[1, 1] + lhs[2, 3] * rhs[1, 2], lhs[0, 0] * rhs[2, 0] + lhs[1, 0] * rhs[2, 1] + lhs[2, 0] * rhs[2, 2], lhs[0, 1] * rhs[2, 0] + lhs[1, 1] * rhs[2, 1] + lhs[2, 1] * rhs[2, 2], lhs[0, 2] * rhs[2, 0] + lhs[1, 2] * rhs[2, 1] + lhs[2, 2] * rhs[2, 2], lhs[0, 3] * rhs[2, 0] + lhs[1, 3] * rhs[2, 1] + lhs[2, 3] * rhs[2, 2]);

        /// <summary>
        /// Executes a matrix-matrix-multiplication float3x4 * float4x3 -> float4x4.
        /// </summary>
        public static float4x4 operator *(float3x4 lhs, float4x3 rhs) => new float4x4(lhs[0, 0] * rhs[0, 0] + lhs[1, 0] * rhs[0, 1] + lhs[2, 0] * rhs[0, 2], lhs[0, 1] * rhs[0, 0] + lhs[1, 1] * rhs[0, 1] + lhs[2, 1] * rhs[0, 2], lhs[0, 2] * rhs[0, 0] + lhs[1, 2] * rhs[0, 1] + lhs[2, 2] * rhs[0, 2], lhs[0, 3] * rhs[0, 0] + lhs[1, 3] * rhs[0, 1] + lhs[2, 3] * rhs[0, 2], lhs[0, 0] * rhs[1, 0] + lhs[1, 0] * rhs[1, 1] + lhs[2, 0] * rhs[1, 2], lhs[0, 1] * rhs[1, 0] + lhs[1, 1] * rhs[1, 1] + lhs[2, 1] * rhs[1, 2], lhs[0, 2] * rhs[1, 0] + lhs[1, 2] * rhs[1, 1] + lhs[2, 2] * rhs[1, 2], lhs[0, 3] * rhs[1, 0] + lhs[1, 3] * rhs[1, 1] + lhs[2, 3] * rhs[1, 2], lhs[0, 0] * rhs[2, 0] + lhs[1, 0] * rhs[2, 1] + lhs[2, 0] * rhs[2, 2], lhs[0, 1] * rhs[2, 0] + lhs[1, 1] * rhs[2, 1] + lhs[2, 1] * rhs[2, 2], lhs[0, 2] * rhs[2, 0] + lhs[1, 2] * rhs[2, 1] + lhs[2, 2] * rhs[2, 2], lhs[0, 3] * rhs[2, 0] + lhs[1, 3] * rhs[2, 1] + lhs[2, 3] * rhs[2, 2], lhs[0, 0] * rhs[3, 0] + lhs[1, 0] * rhs[3, 1] + lhs[2, 0] * rhs[3, 2], lhs[0, 1] * rhs[3, 0] + lhs[1, 1] * rhs[3, 1] + lhs[2, 1] * rhs[3, 2], lhs[0, 2] * rhs[3, 0] + lhs[1, 2] * rhs[3, 1] + lhs[2, 2] * rhs[3, 2], lhs[0, 3] * rhs[3, 0] + lhs[1, 3] * rhs[3, 1] + lhs[2, 3] * rhs[3, 2]);

        /// <summary>
        /// Executes a matrix-vector-multiplication.
        /// </summary>
        public static float4 operator *(float3x4 m, float3 v) => new float4(m[0, 0] * v.x + m[1, 0] * v.y + m[2, 0] * v.z, m[0, 1] * v.x + m[1, 1] * v.y + m[2, 1] * v.z, m[0, 2] * v.x + m[1, 2] * v.y + m[2, 2] * v.z, m[0, 3] * v.x + m[1, 3] * v.y + m[2, 3] * v.z);

        /// <summary>
        /// Executes a component-wise + (addition).
        /// </summary>
        public static float3x4 operator +(float3x4 lhs, float3x4 rhs) => new float3x4(lhs[0, 0] + rhs[0, 0], lhs[0, 1] + rhs[0, 1], lhs[0, 2] + rhs[0, 2], lhs[0, 3] + rhs[0, 3], lhs[1, 0] + rhs[1, 0], lhs[1, 1] + rhs[1, 1], lhs[1, 2] + rhs[1, 2], lhs[1, 3] + rhs[1, 3], lhs[2, 0] + rhs[2, 0], lhs[2, 1] + rhs[2, 1], lhs[2, 2] + rhs[2, 2], lhs[2, 3] + rhs[2, 3]);

        /// <summary>
        /// Executes a component-wise + (addition) with scalar.
        /// </summary>
        public static float3x4 operator +(float s, float3x4 m) => new float3x4(s + m[0, 0], s + m[0, 1], s + m[0, 2], s + m[0, 3], s + m[1, 0], s + m[1, 1], s + m[1, 2], s + m[1, 3], s + m[2, 0], s + m[2, 1], s + m[2, 2], s + m[2, 3]);

        /// <summary>
        /// Executes a component-wise + (addition) with scalar.
        /// </summary>
        public static float3x4 operator +(float3x4 m, float s) => new float3x4(m[0, 0] + s, m[0, 1] + s, m[0, 2] + s, m[0, 3] + s, m[1, 0] + s, m[1, 1] + s, m[1, 2] + s, m[1, 3] + s, m[2, 0] + s, m[2, 1] + s, m[2, 2] + s, m[2, 3] + s);
        ...
        /// 
        /// </summary>
        public static float4x3 Transpose(float3x4 v) => new float4x3(v[0, 0], v[1, 0], v[2, 0], v[0, 1], v[1, 1], v[2, 1], v[0, 2], v[1, 2], v[2, 2], v[0, 3], v[1, 3], v[2, 3]);
