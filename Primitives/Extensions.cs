...
namespace GLSH
{
    internal static class Extensions
    {
        ...
        public static Half HermiteInterpolationOrder3(this Half v) => v * v * (Half)3 - ((Half)2 * v);
        ...
        public static Half HermiteInterpolationOrder5(this Half v) => v * v * v * ((Half)6 * v * v - (Half)15 * v + (Half)10);
