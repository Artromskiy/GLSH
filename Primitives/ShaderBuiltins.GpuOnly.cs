...
namespace GLSH
{
    public partial class ShaderBuiltins
    {
        ...
        public static Vector4 Sample(Texture2DArrayResource texture, SamplerResource sampler, Vector2 texCoords, uint arrayLayer) => throw new ShaderBuiltinException();
        public static Vector4 SampleGrad(Texture2DResource texture, SamplerResource sampler, Vector2 texCoords, Vector2 ddx, Vector2 ddy) => throw new ShaderBuiltinException();
        public static Vector4 SampleGrad(Texture2DArrayResource texture, SamplerResource sampler, Vector2 texCoords, uint arrayLayer, Vector2 ddx, Vector2 ddy) => throw new ShaderBuiltinException();
        public static Vector4 Load(Texture2DResource texture, SamplerResource sampler, Vector2 texCoords, uint lod) => throw new ShaderBuiltinException();
        public static Vector4 Load(Texture2DMSResource texture, SamplerResource sampler, Vector2 texCoords, uint sampleIndex) => throw new ShaderBuiltinException();
        ...
        public static float SampleComparisonLevelZero(DepthTexture2DResource texture, SamplerComparisonResource sampler, Vector2 texCoords, float compareValue) => throw new ShaderBuiltinException();
        public static float SampleComparisonLevelZero(DepthTexture2DArrayResource texture, SamplerComparisonResource sampler, Vector2 texCoords, uint arrayLayer, float compareValue) => throw new ShaderBuiltinException();
