...
namespace GLSH.Extensions
{
    ...
    public static class float3x2Extensions
    {
        ...
        /// </summary>
        public static float[,] GetValues(this float3x2 value) => new[,] { { value.m00, value.m01 }, { value.m10, value.m11 }, { value.m20, value.m21 } };

        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public static float[] GetValues1D(this float3x2 value) => new[] { value.m00, value.m01, value.m10, value.m11, value.m20, value.m21 };
