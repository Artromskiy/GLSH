...
namespace GLSH.Extensions
{
    ...
    public static class double2x2Extensions
    {
        ...
        /// </summary>
        public static double[,] GetValues(this double2x2 value) => new[,] { { value[0, 0], value[0, 1] }, { value[1, 0], value[1, 1] } };

        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public static double[] GetValues1D(this double2x2 value) => new[] { value[0, 0], value[0, 1], value[1, 0], value[1, 1] };
