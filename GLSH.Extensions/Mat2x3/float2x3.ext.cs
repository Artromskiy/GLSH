...
namespace GLSH.Extensions
{
    ...
    public static class float2x3Extensions
    {
        ...
        /// </summary>
        public static float[,] GetValues(this float2x3 value) => new[,] { { value[0, 0], value[0, 1], value[0, 2] }, { value[1, 0], value[1, 1], value[1, 2] } };
        
        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public static float[] GetValues1D(this float2x3 value) => new[] { value[0, 0], value[0, 1], value[0, 2], value[1, 0], value[1, 1], value[1, 2] };
