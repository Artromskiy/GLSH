...
namespace GLSH.Extensions
{
    ...
    public static class double3x3Extensions
    {
        ...
        /// </summary>
        public static double[,] GetValues(this double3x3 value) => new[,] { { value[0, 0], value[0, 1], value[0, 2] }, { value[1, 0], value[1, 1], value[1, 2] }, { value[2, 0], value[2, 1], value[2, 2] } };
        
        /// <summary>
        /// Creates a 1D array with all values (internal order)
        /// </summary>
        public static double[] GetValues1D(this double3x3 value) => new[] { value[0, 0], value[0, 1], value[0, 2], value[1, 0], value[1, 1], value[1, 2], value[2, 0], value[2, 1], value[2, 2] };
