...
using static Runner.TestStatics;
...
public class MinExample
{
    ...
    public FragmentInput VertexShaderFunc(VertexInput input)
    {
        ...
        d = new TestStruct3();
        float2 some = default;
        some = TestStatics.MultiplyByTwo(some);
        some = MultiplyByTwo(some);
...
public struct TestStruct3
{
    ...
    private float f2 = 2;
    private TestStruct2 ts = new();

    public static TestStruct3 SomeTestStruct3_default()
    {
        TestStruct3 ts3;
    ...
    {
        var t = SomeTestStruct3_default(); // call default
